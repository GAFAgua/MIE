...
function createFeatureAnnotations() {
  ...
  const outerContour = [
    [0, 1.72], [0.42, 1.63], [0.84, 1.39], [1.18, 0.95], [1.43, 0.38],
    [1.51, -0.14], [1.42, -0.64], [1.15, -1.15], [0.72, -1.52],
    [0.28, -1.66], [-0.28, -1.66], [-0.72, -1.52], [-1.15, -1.15],
    [-1.42, -0.64], [-1.51, -0.14], [-1.43, 0.38], [-1.18, 0.95],
    [-0.84, 1.39], [-0.42, 1.63], [0, 1.72],
  ];
  ...
  addTube(foil, outerContour, 0.0045);
  addTube(foil, [
    [-1.38, 1.04], [-1.52, 0.42], [-1.48, -0.38], [-1.18, -1.12], [-0.72, -1.58],
    [0, -1.73], [0.72, -1.58], [1.18, -1.12], [1.48, -0.38], [1.52, 0.42], [1.38, 1.04],
  ], 0.0032);
  addTube(foil, [[-1.22, -1.57], [-0.42, -1.73], [0.42, -1.73], [1.22, -1.57]], 0.0032);
  ...
  addMirroredTube(symmetry, [
    [0, 0.48], [-0.22, 0.9], [-0.62, 1.05], [-1.04, 0.92], [-1.32, 0.55],
    [-1.38, 0.18], [-1.2, -0.06], [-0.82, -0.16], [-0.62, -0.42],
    [-0.5, -0.88], [-0.42, -1.55], [-0.78, -1.56], [-1.15, -1.34],
    [-1.38, -0.92], [-1.26, -0.54], [-0.96, -0.34], [-0.88, 0.02],
    [-0.62, 0.36], [-0.32, 0.56], [0, 0.48],
  ], 0.005);
